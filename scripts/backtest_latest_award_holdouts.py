...
def main() -> int:
    ...
    report = {
        ...
        "selection_notes": [
            ...
            "세부기준 (산림청예규 제728호, 2025-12-01), i.e. 산림사업 did not follow the "
            "국가계약 revision. Limit: whether that 예규 별표 tiers the rate by 추정가격 "
            "band is unverified (every observed sample is ≤3.3억), so the flat rate is "
            "evidence-based and NOT an encoding of the 예규 별표.",
