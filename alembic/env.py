...
from app.models import models  # noqa: E402,F401  -- ensures all models are registered on Base.metadata

# Tell Alembic where the live DB URL lives. Overrides the placeholder in
# alembic.ini so `alembic upgrade head` works against the configured app DB.
config.set_main_option("sqlalchemy.url", settings.DATABASE_URL)

# Used by --autogenerate to diff against the declared schema.
