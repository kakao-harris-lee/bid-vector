...
#
# * 기관 κ=12: 실측 분포(중앙값대 표본 <10)의 기관 대부분이 상위 계층에 절반 이상
#   수축되고, ≥30 표본 기관(204곳)부터 자기 신호가 지배(≥71%)한다.
# * 공종 κ=40: 공종은 표본이 수천 단위라 사실상 자기 평균을 유지하되, 표본이 수십
#   건뿐인 신생 공종은 전역으로 절반쯤 수축된다.
